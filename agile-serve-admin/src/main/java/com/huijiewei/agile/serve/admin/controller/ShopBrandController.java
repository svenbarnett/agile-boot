...
public class ShopBrandController {
    ...
    public SearchPageResponse<ShopBrandResponse> actionIndex(
        ...
        return this.shopBrandService.search(withSearchFields, request, pageable);
    }
    ...
    public ShopBrandResponse actionView(@PathVariable("id") Integer id) {
        return this.shopBrandService.view(id);
    }
