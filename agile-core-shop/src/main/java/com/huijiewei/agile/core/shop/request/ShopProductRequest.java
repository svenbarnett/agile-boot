...
public class ShopProductRequest {
    ...
    @Exist(targetEntity = ShopCategory.class, targetProperty = "id", message = "你选择的商品分类不存在")
    private Integer shopCategoryId;

    @NotNull
    @Schema(description = "商品品牌", required = true)
    @Exist(targetEntity = ShopBrand.class, targetProperty = "id", allowValues = "0", message = "你选择的商品品牌不存在")
